// Content for "zones" article
import type { ArticleContent } from "../types";

const content: ArticleContent = {
  content: `## Votre corps est une machine a plusieurs vitesses

Imaginez votre corps comme une voiture hybride dotee de plusieurs moteurs. A basse vitesse, vous roulez a l'electrique : c'est economique, silencieux, vous pouvez tenir des heures. Quand vous accelerez, le moteur thermique prend le relais : plus puissant, mais la consommation grimpe et l'autonomie chute. Poussez a fond, et vous passez en mode boost : des performances maximales, mais impossibles a maintenir plus de quelques secondes.

Votre metabolisme fonctionne exactement de la meme facon. Selon l'intensite de l'effort, votre corps recrute differents systemes energetiques, chacun avec ses avantages et ses limites. Comprendre ces mecanismes, c'est la cle pour progresser efficacement sans vous epuiser.

---

## Les trois filieres energetiques

Avant de parler de zones, il faut comprendre comment votre corps produit l'energie necessaire a la course. Trois systemes cohabitent, se relayant selon l'intensite et la duree de l'effort.

### La filiere aerobie : votre moteur d'endurance
...
Cet acide s'accumule dans les muscles et provoque cette sensation de brulure caracteristique. Vous connaissez bien ce moment ou vos jambes deviennent lourdes et ou chaque foulee devient un combat. C'est le systeme lactique a l'oeuvre, principalement sollicite en Zone 4 et Zone 5.

### La filiere anaerobie alactique : l'explosion

Pour les efforts maximaux de quelques secondes, un troisieme systeme entre en jeu. Il puise dans les reserves de creatine phosphate, une molecule stockee directement dans les muscles. C'est l'energie immediate, celle du sprint pur.

Cette filiere s'epuise en 8 a 10 secondes, mais elle n'a besoin que de 2 a 3 minutes pour se reconstituer. C'est la Zone 6, celle des accelerations fulgurantes et des fins de course au sprint.
...
La Zone 3 est une zone de transition, parfois appelee "zone grise" car elle ne developpe pas aussi efficacement une filiere specifique. Elle correspond a une allure soutenue mais tenable sur une longue duree - typiquement votre allure marathon ou semi-marathon.

Ici, vous commencez a produire de l'acide lactique, mais votre corps parvient encore a l'eliminer au fur et a mesure. C'est l'equilibre : vous pouvez parler par phrases courtes, mais la discussion devient moins naturelle.

Cette zone est utile pour les sorties longues rythmees et pour apprendre a "gerer" un effort prolonge. Elle prepare le mental autant que le physique.

**Sensation typique** : effort soutenu, concentration necessaire pour maintenir l'allure.
...
En complement du cardio, l'echelle de Borg (RPE de 1 a 10) vous aide a calibrer vos sensations :
...
| Z5 | 8-9 | Tres difficile, respiration maximale |
| Z6 | 10 | Effort maximal, quelques secondes |

Avec l'experience, vous apprendrez a correler vos sensations avec les donnees de votre montre.
