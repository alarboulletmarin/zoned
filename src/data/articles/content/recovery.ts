...
**L'environnement** : chambre fraiche (18-20C), obscure (stores ou masque), silencieuse. La temperature corporelle doit baisser pour s'endormir - une piece surchauffee l'empeche.

**Les ecrans** : leur lumiere bleue inhibe la melatonine, l'hormone du sommeil. Evitez-les au moins 30 minutes avant de vous coucher, idealement une heure.

**L'alimentation** : un repas trop copieux ou trop tardif perturbe l'endormissement. Mais se coucher le ventre vide aussi - une legere collation glucidique peut aider.

**La cafeine** : sa demi-vie est de 5-6 heures. Un cafe a 16h signifie encore de la cafeine dans le sang a 22h. Fixez-vous une limite en debut d'apres-midi.
...
Dans les 30 a 60 minutes suivant un effort, votre corps est dans un etat de receptivite particuliere. Les enzymes qui stockent le glycogene sont suractivees. Les transporteurs de glucose dans les muscles sont a leur maximum. C'est le moment ideal pour reconstituer vos reserves.

Cette "fenetre anabolique" n'est pas un mythe - les etudes la confirment. Manquer ce creneau ne vous empechera pas de recuperer, mais vous recupererez moins vite.
...
**De l'eau** pour compenser les pertes hydriques. La sueur emporte aussi des electrolytes (sodium, potassium) - une boisson legerement salee ou un aliment sale aide a la rehydratation.
...
- Un smoothie fruits + proteine en poudre

Le repas principal, 2-3 heures apres, peut etre plus complet : pates ou riz, proteine de qualite (poulet, poisson, oeufs), legumes, et une source de bonnes graisses (huile d'olive, avocat).
...
- Infections frequentes (systeme immunitaire affaibli)
