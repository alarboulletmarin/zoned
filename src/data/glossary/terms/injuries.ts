...
export const injuriesTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    fullDefinition:
      "Le syndrome rotulien (ou syndrome femoro-patellaire, SFP) est l'une des causes les plus frequentes de douleur au genou chez les coureurs. Il se manifeste par une douleur diffuse autour ou derriere la rotule, aggravee par la montee et la descente d'escaliers, les squats, et la position assise prolongee (signe du cinema). Les causes sont multifactorielles : faiblesse du quadriceps (surtout le vaste medial), faiblesse des muscles fessiers, mauvais alignement de la rotule, surcharge d'entrainement, et raideur des ischio-jambiers ou du quadriceps. Le traitement repose principalement sur le renforcement musculaire cible : quadriceps (exercices isometriques puis progressifs), fessiers, et travail de proprioception. La douleur peut prendre plusieurs semaines a se resoudre. Consulter un kinesitherapeute specialise en sport pour un programme personnalise.",
    fullDefinitionEn:
  ...
  },
  {
    ...
    fullDefinition:
      "Les crampes musculaires associees a l'exercice (EAMC) sont des contractions involontaires, douloureuses et temporaires d'un muscle pendant ou juste apres un effort. Elles touchent le plus souvent les mollets, les ischio-jambiers et les quadriceps chez les coureurs. Les mecanismes exacts restent debattus en science. Deux theories principales coexistent : la theorie de la deshydratation et du desequilibre electrolytique (perte de sodium, potassium, magnesium), et la theorie neuromusculaire (fatigue alterant le controle nerf-muscle). La fatigue musculaire est probablement le facteur le plus important. La prevention passe par un entrainement adapte au niveau de competition, une hydratation adequate avec des electrolytes, et un echauffement suffisant. En cas de crampe, l'etirement doux et le massage du muscle touche sont les gestes immediats les plus efficaces.",
    fullDefinitionEn:
      "Exercise-associated muscle cramps (EAMC) are involuntary, painful, and temporary muscle contractions during or shortly after exertion. They most commonly affect the calves, hamstrings, and quadriceps in runners. The exact mechanisms remain scientifically debated. Two main theories coexist: the dehydration and electrolyte imbalance theory (loss of sodium, potassium, magnesium), and the neuromuscular theory (fatigue altering nerve-muscle control). Muscle fatigue is likely the most significant factor. Prevention involves training appropriate to competition level, adequate hydration with electrolytes, and sufficient warm-up. During a cramp, gentle stretching and massage of the affected muscle are the most effective immediate responses.",
    example:
  ...
  },
  {
    ...
    fullDefinition:
      "Le syndrome des loges (ou syndrome compartimental) est une pathologie dans laquelle la pression a l'interieur d'un compartiment musculaire (enveloppe de fascia inextensible entourant un groupe musculaire) augmente de maniere excessive. Il existe deux formes : le syndrome chronique d'effort (le plus frequent chez les coureurs) et le syndrome aigu (urgence chirurgicale). La forme chronique se manifeste par une douleur croissante, une sensation de tension extreme et parfois des engourdissements dans la jambe pendant l'effort, qui disparaissent au repos en 15-30 minutes. La loge anterieure de la jambe est la plus souvent touchee. Les causes exactes sont mal comprises, mais l'augmentation du flux sanguin a l'effort dans un espace confine semble jouer un role central. Le diagnostic se confirme par une mesure de pression intra-compartimentale. Le traitement conservateur (modification de l'entrainement, technique de course, ortheses) est tente en premier. En cas d'echec, une fasciotomie chirurgicale peut etre proposee. Consulter un medecin du sport devant toute douleur de jambe reproductible a l'effort et cedant au repos.",
    fullDefinitionEn:
