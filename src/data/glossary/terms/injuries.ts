...
export const injuriesTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    example:
      "Pendant ta première sortie longue avec de nouvelles chaussures, une ampoule se forme sur le petit orteil. La prochaine fois, applique de la vaseline et porte des chaussettes en laine merinos.",
    exampleEn:
  ...
  },
  {
    ...
    category: "injuries",
    shortDefinition:
      "Hematome sous l'ongle du pied cause par les impacts répétés de l'orteil contre la chaussure.",
    shortDefinitionEn:
      "Subungual hematoma caused by repeated impact of the toe against the shoe.",
    fullDefinition:
      "L'ongle noir du coureur (hématome sous-ungueal) est une accumulation de sang sous l'ongle de l'orteil, causee par les microtraumatismes répétés du bout de l'orteil contre le dessus ou l'avant de la chaussure. L'ongle prend une coloration bleu-noir caractéristique. C'est une blessure très fréquente chez les coureurs de longue distance, surtout lors de descentes prolongees ou de courses sur route. Les facteurs de risque principaux sont : chaussures trop petites (il faut environ une demi-pointure de plus que sa taille habituelle pour la course), lacage trop lache permettant au pied de glisser vers l'avant, ongles trop longs, et courses longues en descente. La prévention consiste a choisir des chaussures avec un espace suffisant a l'avant (largeur du pouce entre l'orteil et le bout de la chaussure), couper les ongles régulièrement, et ajuster le lacage. L'ongle tombe généralement de lui-même et repousse en quelques mois. Consulter un médecin en cas de douleur intense ou de signes d'infection.",
    fullDefinitionEn:
  ...
  },
  {
    ...
    example:
      "A chaque fois que tu cours plus de 15 minutes, tu ressens une tension extreme dans l'avant de la jambe avec des fourmillements, et tout disparait 20 minutes après l'arrêt. C'est un tableau typique de syndrome des loges chronique.",
    exampleEn:
