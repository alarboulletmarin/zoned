...
//
// Le français est au tutoiement ici comme partout ailleurs : ce fichier était
// au vouvoiement et a été basculé entièrement, en une fois, comme le veut la
// règle du dépôt. Ne pas remélanger les deux.
...
export const COMMAND_SURFACES: CommandSurface[] = [
  ...
  },
  {
    ...
    subtitle: "Pose tes zones FC et tes allures depuis ta VMA ou ta FCmax",
  ...
  },
  {
    ...
    subtitle: "Estime ta VMA à partir d'un résultat de course",
  ...
  },
  {
    ...
    subtitle: "Estime ta FTP depuis un test 20 minutes ou un ramp test",
  ...
  },
  {
    ...
    subtitle: "Estime ta CSS depuis un test 400 m + 200 m",
  ...
  },
  {
    ...
    subtitle: "Planifie tes passages pour tenir ton objectif chrono",
  ...
  },
  {
    ...
    subtitle: "Prédis tes temps sur toutes les distances depuis un résultat",
  ...
  },
  {
    ...
    title: "Contribuer",
    titleEn: "Contribute",
    subtitle: "Propose du contenu, signale un bug, donne ton avis",
  ...
  },
  {
    ...
    title: "Mes plans",
    titleEn: "My Plans",
    subtitle: "Tes plans d'entraînement",
  ...
  },
  {
    ...
    title: "Comparatifs",
    titleEn: "Compare",
    subtitle: "Compare Zoned aux autres outils d'entraînement",
  ...
  },
  {
    ...
    subtitle: "Tes données, ton niveau et tes records",
  ...
  },
  {
    ...
    title: "Favoris",
    titleEn: "Favorites",
    subtitle: "Tes séances et tes contenus enregistrés",
  ...
  },
  {
    ...
    title: "Quiz",
    titleEn: "Quiz",
    subtitle: "Teste tes connaissances en entraînement",
  ...
  // reproduit.
  {
    ...
    title: "Aujourd'hui",
    titleEn: "Today",
    subtitle: "Ta séance du jour, et les deux raccourcis",
    subtitleEn: "Today's session, and the two shortcuts",
    url: "/today",
    keywords: ["aujourd'hui", "today", "accueil", "home", "reprendre", "resume", "cockpit"],
    featured: true,
  },
  {
    id: "library",
    ...
    title: "Bibliothèque",
    titleEn: "Library",
    subtitle: "Toutes les séances, par pratique",
    subtitleEn: "Every session, by discipline",
    url: "/library",
    keywords: ["bibliotheque", "library", "seances", "sessions", "catalogue", "route", "trail", "ultra"],
    featured: true,
  },
  {
    id: "library-draw",
    section: "page",
    title: "Tire-moi une séance",
    titleEn: "Draw me a session",
    subtitle: "Le hasard choisit pour toi",
    subtitleEn: "Let chance pick for you",
    url: "/library/draw",
    keywords: ["tirage", "hasard", "aleatoire", "random", "draw", "surprise", "quiz"],
    featured: true,
  },
  {
    id: "collections",
    ...
    title: "Collections",
    titleEn: "Collections",
    subtitle: "Des séances regroupées par objectif",
    subtitleEn: "Sessions grouped by goal",
    url: "/collections",
    keywords: ["collections", "series", "progressions", "objectif", "goal"],
  },
  {
    id: "weeks",
    section: "page",
    title: "Ma semaine",
    titleEn: "My week",
    subtitle: "Composer une semaine sans s'engager sur un plan",
    subtitleEn: "Build a week without committing to a plan",
    url: "/weeks",
    keywords: ["semaine", "week", "hebdo", "weekly", "composer", "build"],
    featured: true,
  },
  {
    id: "weeks-new",
    ...
    titleEn: "New week",
    subtitle: "Composer ou partir d'une semaine prête",
    subtitleEn: "Compose one, or start from a ready-made week",
    url: "/weeks/new",
    keywords: ["nouvelle semaine", "new week", "creer", "create", "generer", "generate"],
  },
  {
    id: "weeks-prebuilt",
    section: "page",
    title: "Semaines prêtes à l'emploi",
    titleEn: "Ready-made weeks",
    subtitle: "Dix semaines déjà écrites",
    subtitleEn: "Ten weeks already written",
    url: "/weeks/new/prebuilt",
    keywords: ["semaines pretes", "ready weeks", "prebuilt", "catalogue"],
  },
  {
    id: "workout-builder",
    section: "page",
    title: "Créer une séance",
    titleEn: "Build a session",
    subtitle: "Écrire ta propre séance, bloc par bloc",
    subtitleEn: "Write your own session, block by block",
    url: "/workout/builder",
    keywords: ["creer", "build", "editeur", "builder", "personnalisee", "custom"],
  },
  {
    id: "my-zones",
    section: "page",
    title: "Mes zones",
    titleEn: "My zones",
    subtitle: "Tes six zones, depuis ta VMA ou ta FCmax",
    subtitleEn: "Your six zones, from your vVO2max or max HR",
    url: "/my-zones",
    keywords: ["mes zones", "my zones", "vma", "fcmax", "personnalisees", "personal"],
    featured: true,
  },
  {
    id: "learn",
    ...
    title: "Comprendre",
    titleEn: "Learn",
    subtitle: "Les articles de fond",
    subtitleEn: "The long-form articles",
    url: "/learn",
    keywords: ["comprendre", "learn", "articles", "apprendre", "lire", "read"],
  },
  {
    id: "glossary",
    section: "page",
    title: "Lexique",
    titleEn: "Glossary",
    subtitle: "Le vocabulaire de l'entraînement, défini",
    subtitleEn: "Training vocabulary, defined",
    url: "/glossary",
    keywords: ["lexique", "glossaire", "glossary", "definition", "vocabulaire", "terme"],
  },
  {
    id: "calc-converter-alt",
    section: "calculator",
    title: "Calculateur d'allures",
    titleEn: "Pace calculator",
    subtitle: "Tes chronos sur cinq distances, depuis ta VMA",
    subtitleEn: "Your times over five distances, from your vVO2max",
    url: "/calculators/allures",
