...
/** Un seul pied de page, le même sur toutes les routes.
 *
 *  Il y avait ici une table de variantes : le cockpit n'avait qu'une ligne de
 *  licence en encre claire, tout le reste portait quatre colonnes de liens
 *  surmontant une barre de cinq éléments. Deux pieds de page pour la même
 *  signature, et sur téléphone celui des pages publiques se dépliait en cinq
 *  rangées. Le pied de page ne dépend plus de la route : une ligne, partout,
 *  et les quatre colonnes repliées derrière Plan du site (voir Footer.tsx).
 *
 *  Reste la seule exception qui n'est pas une question de style :
 *  FULLSCREEN_ROUTES, où la carte revendique le viewport entier. */
                  ...
                  <div className="zn-page">
                    <ErrorBoundary>
                        <Routes>
                          ...
                          <Route path="/weeks/shared" element={<SharedWeekPage />} />
