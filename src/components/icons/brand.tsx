 ...
 * from `index.tsx` alongside the generated Material set.
 *
 * - StravaIcon: Strava brand mark. Already a filled path.
 * - GithubIcon: GitHub brand mark, drawn from Lucide's `github` outline
 *   (ISC, © Lucide Contributors). See THIRD-PARTY.md.
 *
 * Both ignore `filled`: a brand mark has a single authorised form.
 */
