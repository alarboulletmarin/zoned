...
export function TopBar({ onMobileMenuOpen }: TopBarProps) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 h-14 border-b border-filet bg-background">
      <div className="flex h-full items-center gap-4 px-4 md:px-6">
        {isCompact ? (
          /* ───── Mobile ─────────────────────────────────────────────────── */
          <>
            <Link to="/" viewTransition className="flex items-center shrink-0">
          ...
          <>
            ...
            <nav
              ...
              className="hidden md:flex items-center gap-1 pl-3 ml-1 border-l-2 border-foreground h-6"
            >
            ...
            >
              ...
              <kbd className="pointer-events-none ml-auto hidden select-none items-center gap-1 border border-foreground bg-secondary px-1.5 font-mono text-[10px] font-medium text-muted-foreground xl:inline-flex">
                {isMac ? (
                  <>
...
function NavSectionTrigger({
  ...
  const triggerClass = cn(
    "px-3 py-1.5 font-mono text-xs tracking-wide uppercase transition-colors inline-flex items-center gap-1",
    active
  ...
  return (
    <div className="relative group" ref={wrapRef}>
      ...
      >
        <div className="bg-popover text-popover-foreground border-2 border-foreground p-1.5 min-w-[260px]">
            ...
            {section.children!.map((child) => (
              <li key={child.to}>
                <Link
                  ...
                  className="block px-3 py-2 hover:bg-secondary transition-colors"
                >
