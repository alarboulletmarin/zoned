const e={content:`## Connaître ses chiffres pour mieux s'entraîner
...
Pour 1500m en 5:30 (330 secondes) : VMA = 1500 / 330 x 3,6 = 16,4 km/h
...
Les tests sont un moment de vérité : 6 minutes de lucidité sur votre condition physique actuelle. L'important n'est pas le chiffre absolu, mais ce que vous en faites. Avec votre VMA et votre FCmax en poche, vous pouvez maintenant configurer vos zones et commencer un entraînement véritablement personnalisé.`,contentEn:`## Know your numbers to train better
...
**Calculation:**
MAS (km/h) = distance (m) / time (s) x 3.6

For 1500m in 5:30 (330 seconds): MAS = 1500 / 330 x 3.6 = 16.4 km/h
...
The Tanaka formula (208 - 0.7 x age) is slightly better but remains an approximation. If you base your zones on an HRmax that's off by 10 beats, all your ranges will be shifted.
...
Tests are a moment of truth: 6 minutes of clarity on your current physical condition. What matters isn't the absolute number, but what you do with it. With your MAS and HRmax in hand, you can now configure your zones and start truly personalized training.`};export{e as default};
