const e={content:`## Votre corps est une machine à plusieurs vitesses
...
> 📊 Les marathoniens d'élite passent 80% de leur entraînement en Zone 1-2. Ce n'est pas un manque d'ambition, c'est de la science.
...
> 📌 La Zone 2 est la zone la plus importante pour progresser à long terme. Ne la négligez jamais sous prétexte qu'elle semble "trop facile".
...
> ⚠️ Ne dépassez jamais deux séances de VMA par semaine. Le risque de blessure et de surentraînement augmente fortement au-delà.
...
La formule classique "220 - âge" est simple mais imprécise, avec un écart-type de 10-12 battements. La formule de Tanaka (208 - 0.7 x âge) est légèrement plus fiable. Mais gardez en tête qu'aucune formule ne remplace une mesure directe.

> 💡 Si vous n'avez pas de cardiofréquencemètre, utilisez le "test de la parole" : en Zone 2, vous devez pouvoir parler en phrases complètes sans essoufflement.
...
Vous connaissez maintenant la théorie. L'étape suivante est de calculer vos zones personnelles et de les appliquer à vos séances. Notre calculateur vous permet d'obtenir vos plages précises basées sur votre FCmax et votre VMA.`,contentEn:`## Your body is a multi-speed machine
...
For maximum efforts of a few seconds, a third system kicks in. It draws from créatine phosphate réserves, a molecule stored directly in muscles. This is immediate energy, the pure sprint.
...
Zone 1 is recovery jogging in the strictest sense. You should be able to hold a complète conversation without any breathlessness. If you can't tell your training partner about your weekend, you're going too fast.

At this intensity, your body burns essentially fat. Increased blood flow accelerates the élimination of metabolic waste accumulated during intense sessions. This is why a slow jog the day after a hard session recovers better than complète rest.
...
The maximum heart rate (HRmax) percentages given above are averages. For précise training, you need to know your own HRmax.

### The field test

The most reliable method remains testing. After a complète warm-up of 15-20 minutes, chain 3 to 4 hills of 2-3 minutes with progressive acceleration. On the last one, give everything you have. The peak shown on your watch will be close to your actual HRmax.

### The formulas

The classic "220 - age" formula is simple but imprécise, with a standard deviation of 10-12 beats. The Tanaka formula (208 - 0.7 x age) is slightly more reliable. But keep in mind that no formula replaces direct measurement.

> 💡 If you don't have a heart rate monitor, use the "talk test": in Zone 2, you should be able to speak in complète sentences without breathlessness.
...
With expérience, you'll learn to correlate your sensations with your watch data.
...
You now know the theory. The next step is to calculate your personal zones and apply them to your sessions. Our calculator allows you to get your précise ranges based on your HRmax and VO2max speed.`};export{e as default};
