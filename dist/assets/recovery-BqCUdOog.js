...
> 💡 Visez 8 à 9 heures de sommeil par nuit. Ajoutez une sieste de 20 minutes après une séance intense pour accélérer la récupération.
...
> ⚠️ Si votre fréquence cardiaque au repos augmente de 5+ battements et que vos performances chutent malgré l'entraînement, arrêtez-vous. Ce sont des signaux sérieux de surentraînement.
...
Intégrez la récupération comme une partie de votre entraînement, pas comme une absence d'entraînement. Dormez suffisamment, mangez correctement après l'effort, respectez les jours faciles. Votre corps vous le rendra en performances.`,contentEn:`## The training paradox
...
Integrate recovery as part of your training, not as an absence of training. Sleep enough, eat properly after effort, respect easy days. Your body will repay you in performance.`};export{e as default};
