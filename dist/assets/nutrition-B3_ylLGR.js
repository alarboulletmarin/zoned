const e={content:`## Courir, c'est brûler
...
> 📌 Le timing nutritionnel autour de l'entraînement est aussi important que le contenu de l'assiette : mangez trop tôt et l'énergie n'est pas disponible, trop tard et la digestion gêne l'effort.
...
Avant une compétition importante, reproduisez exactement votre stratégie de ravitaillement lors d'une sortie longue. Mêmes marques, mêmes quantités, mêmes timings. Pas de mauvaises surprises le jour J.
...
> 💡 Vérifiez la couleur de vos urines avant chaque séance : jaune pâle = bien hydraté, jaune foncé = buvez avant de partir.
...
> ⚠️ Ce que vous mangez 30 minutes avant la course ne sera pas digéré à temps pour fournir de l'énergie - ça ne fera que créer de l'inconfort.
...
> 📊 Une déshydratation de seulement 2% du poids corporel diminue les performances de 10 à 20%. Sur un semi-marathon, c'est 5 à 10 minutes de perdues.
...
Chaque coureur est différent. Ces principes sont des bases - à vous de les adapter à votre métabolisme, vos goûts, et vos réactions individuelles.`,contentEn:`## Running is burning
...
Poor nutrition is like starting a road trip with a half-empty tank: you won't get very far, and the expérience will be painful. Good nutrition means having optimal fuel at the right time - and making the difference between a suffered session and a mastered one.
...
The général rule: the larger the meal, the further it should be from the effort.

**3-4 hours before**: normal complète meal. This is your last "real" meal before an important session or compétition. Favor complex carbohydrates (pasta, rice, whole grain bread), a source of lean protein (chicken, fish, eggs), cooked vegetables rather than raw. Avoid excess fats that slow gastric emptying.
...
For an outing under 60 minutes, your body has enough réserves. Water is enough - and even water isn't essential for a cool day and easy outing.
...
Plain water generally suffices. If effort is intense or in high heat, a sports drink with électrolytes (mainly sodium) helps maintain hydration balance.
...
Beyond 90 minutes of effort, your muscle glycogen réserves begin to deplete. If you don't replenish them, you'll "hit the wall" - that brutal sensation where legs become lead and every stride demands disproportionate effort.
...
**Fueling strategy:** start eating early, around 45 minutes of effort, when you still feel good. Don't wait until you're hungry - at that point, you're already in déficit.
...
**Enhanced hydration:** in hot weather or very long effort, switch to a sports drink with électrolytes to compensate for salt losses. A 2% body weight dehydration decreases performance by 10-20%.
...
**Carbohydrates** replenish muscle glycogen. After a long or intense outing, your réserves are depleted - you start your next session with a half-full tank if you don't reload them.
...
The recovery snack doesn't replace a real meal. A few hours after effort, have a complète, balanced meal:

- **Complex carbs**: pasta, rice, potatoes, quinoa
- **Quality protein**: chicken, fish, eggs, légumes
- **Vegetables**: for vitamins, minerals and fiber
- **Good fats**: olive oil, avocado, nuts

After very long effort (marathon, 3h+ outing), this meal is particularly important. Your réserves are deeply depleted - it takes several meals to fully replenish them.
...
If weight loss is a goal, the caloric déficit should be moderate and never created by cutting before/during/after training.
...
Every runner is different. These principles are foundations - it's up to you to adapt them to your metabolism, your tastes, and your individual reactions.`};export{e as default};
