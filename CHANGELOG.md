...
- Opening the form puts the keyboard on the duration. Focus landed on the date, which is already right, so the focus ring posted a second vermillon call opposite the save button to point at the one thing there was nothing to do about. Editing focuses nothing, since one comes to correct a precise field and the keyboard would cover the ones being re-read
